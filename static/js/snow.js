...
$(function() {
  ...
  particleImage.src = "static/images/snow.png";
  var snowNum = 150; //雪花数量

  function init() {
    camera = new THREE.PerspectiveCamera(65, containerWidth / containerHeight, 1, 10000);
    camera.position.z = 650;//此处可更改雪花在屏幕的宽度
	camera.position.x = 20;//此处可更改雪花在屏幕的宽度
	camera.position.y = 20;//此处可更改雪花在屏幕的宽度
